...
from create_vgg16 import create_vgg16
...
for i in range(epoch):
    ...
    avg_train_loss, avg_train_acc = train_epoch(model, train_dataloader, loss_fn, optimizer, device, writer, total_train_step)
    ...
    if avg_val_acc > best_accuracy:
        ...
        torch.save(model.state_dict(), "ModelSaved_MSel(VGG16)/vgg16.pth")
        # 保存最佳 epoch 的混淆矩阵
        ...
        plt.savefig(f'CM_MSel_VGG16/bestEpoch_{i+1}.png')
        plt.close()
